...
argparser.add_argument('--intra_gap', '--intra_domain_gap_tolerance', type=int, default=30, help='Optional gap size between HMM sequence and query sequence for non-contiguous alignment within a domain (default = 35)')
argparser.add_argument('--inter_gap', '--inter_domain_gap_tolerance', type=int, default=30, help='Optional gap size between two domains sequences for non-contiguous merging (default = 20)')
argparser.add_argument('--overlap', '--domain_overlap_tolerance', type=int, default=40, help='Optional overlap between HMM domain sequence and fasta aligment in consecutive or split domains  (default = 15)')
